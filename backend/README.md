...
## Project Structure
    ...
    ├── testapiautocatalog_106666  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_106666`
...
2. Clone this repo and `cd testapiautocatalog_106666`
